...
document.write("<p><br><br>Аттрибуты <b>async</b> и <b>defer</b> служат для асинхронной загрузки страницы, не дожидаясь загрузки и выполнения скриптов. А <b>defer</b>, в свою очередь, соблюдает порядок скриптов, и ждёт загрузки всей страницы.</p>");